...
from utils.logging import DictAverageMeter
from utils.metrics import compute_dice, compute_kits19_metrics
...
def train(train_dataloader, model, criterion, optimizer, config):
    ...
    num_iters = config.TRAIN.NUM_BATCHES 
    ...
    for i in tqdm(range(num_iters), total=num_iters):
        ...
        classes = train_dataloader.generator.CLASSES
