...
class PlainUNet3D(UNet3D):
    ...
    def __init__(self,
        ...
        super(PlainUNet3D, self).__init__(in_channels, out_channels, base_feature_channels, max_feature_channels,
                                          ...
                                          pre_activation, residue)


class PreActUNet3D(UNet3D):
    """PreAct 3D U-Net proposed in the paper “An Attempt at Beating the 3D U-Net” (arXiv: http://arxiv.org/abs/1908.02182).
    """
    ...
    def __init__(self,
                 ...
                 pre_activation=True,
                 residue=False):
        super(PreActUNet3D, self).__init__(in_channels, out_channels, base_feature_channels, max_feature_channels,
                                           base_module, num_levels, normalization, nonlinearity, conv_kernel_size,
                                           padding_width, first_downsample_stride, decoder_min_channels, initializer,
                                           pre_activation, residue)
...
class ResidualUNet3D(UNet3D):
    """Residual 3D U-Net proposed in the paper “An Attempt at Beating the 3D U-Net” (arXiv: http://arxiv.org/abs/1908.02182).
    """
    ...
    def __init__(self,
                 ...
                 pre_activation=False,
                 residue=True):
        super(ResidualUNet3D, self).__init__(in_channels, out_channels, base_feature_channels, max_feature_channels,
                                             base_module, num_levels, normalization, nonlinearity, conv_kernel_size,
                                             padding_width, first_downsample_stride, decoder_min_channels, initializer,
                                             pre_activation, residue)
